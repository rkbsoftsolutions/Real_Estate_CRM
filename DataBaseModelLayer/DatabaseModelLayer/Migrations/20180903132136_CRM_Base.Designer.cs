...
namespace CRM.DatabaseModelLayer.Migrations
{
    ...
    [Migration("20180903132136_CRM_Base")]
    partial class CRM_Base
    {
            ...
            modelBuilder.Entity("CRM.DatabaseModelLayer.Models.Mouels_Roles_Link", b =>
                {
                    ...
                    b.Property<Guid?>("application_ModulesId");

                    b.HasKey("Id");

                    b.HasIndex("applicationRolesId");

                    b.HasIndex("application_ModulesId");
            ...
            modelBuilder.Entity("CRM.DatabaseModelLayer.Models.Mouels_Roles_Link", b =>
                {
                    ...
                    b.HasOne("CRM.DatabaseModelLayer.Models.Application_Modules", "application_Modules")
                        .WithMany()
                        .HasForeignKey("application_ModulesId");
                });
